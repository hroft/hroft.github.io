...
function b(p){for(var q=g,t=0;64>t;t+=4)q[t/4]=p[t]<<24|p[t+1]<<16|p[t+2]<<8|p[t+3];for(t=16;80>t;t++)p=q[t-3]^q[t-8]^q[t-14]^q[t-16],q[t]=(p<<1|p>>>31)&4294967295;p=e[0];var z=e[1],E=e[2],W=e[3],hd=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var Wa=W^z&(E^W);var Vb=1518500249}else Wa=z^E^W,Vb=1859775393;else 60>t?(Wa=z&E|W&(z|E),Vb=2400959708):(Wa=z^E^W,Vb=3395469782);Wa=((p<<5|p>>>27)&4294967295)+Wa+hd+Vb+q[t]&4294967295;hd=W;W=E;E=(z<<30|z>>>2)&4294967295;z=p;p=Wa}e[0]=e[0]+p&4294967295;e[1]=e[1]+
z&4294967295;e[2]=e[2]+E&4294967295;e[3]=e[3]+W&4294967295;e[4]=e[4]+hd&4294967295}
...
function xg(a){var b=window.location.search,c=Yb(a),d=Xb(a.match(Wb)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=kg(b),f={};H(ug,function(g){e[g]&&(f[g]=e[g])});
return lg(a,f||{},!1)}
...
function X(a){return new V(function(b,c){ih(a,b,c)})}
...
function ph(a,b){return lh(a,["databases"],"readwrite",function(c){c=mh(c,"databases");return X(c.f.put(b,void 0))})}
...
n=oh.prototype;n.add=function(a,b){return X(this.f.add(a,b))};
...
sh.prototype.count=function(a){return X(this.f.count(a))};
sh.prototype.get=function(a){return X(this.f.get(a))};
...
function uh(a){return X(a).then(function(b){return null===b?null:new vh(a,b)})}
vh.prototype["delete"]=function(){return X(this.f["delete"]()).then(function(){})};
vh.prototype.getValue=function(){return this.f.value};
vh.prototype.update=function(a){return X(this.f.update(a))};function wh(a,b,c){function d(){p||(p=new kh(f.result,{closed:m}));return p}
...
v(Mh,V);Mh.reject=V.reject;Mh.resolve=V.resolve;Mh.all=V.all;var Nh;function Oh(){return K(this,function b(){return x(b,function(c){if(!Nh)try{Nh=Lh(1,{upgrade:function(d,e){1>e&&(nh(d,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).f.createIndex("newRequest",["status","authHash","timestamp"],{unique:!1}),nh(d,"sapisid"))}})}catch(d){if(!gh(d))return R(d),c["return"](Promise.reject(d));
...
function Sh(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Oh(),2);d=e.g;return e["return"](lh(d,["LogsRequestsStore"],"readwrite",function(f){var g=mh(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",X(g.f.put(h,void 0)).then(function(){return h})})}))})})}
function Th(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Oh(),2);d=e.g;return e["return"](lh(d,["LogsRequestsStore"],"readwrite",function(f){var g=mh(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,X(g.f.put(h,void 0)).then(function(){return h})):Mh.resolve(void 0)})}))})})}
...
;var Vh=Ke("network_polling_interval",3E4);function Wh(){this.i=0;this.f=window.navigator.onLine;Xh(this);Yh(this)}
function Zh(){Wh.f||(Wh.f=new Wh);return Wh.f}
function $h(a){var b=ai,c=bi;(new N(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)});
ci(a)}
function Yh(a){window.addEventListener("online",function(){a.f=!0;a.g&&a.g()})}
function Xh(a){window.addEventListener("offline",function(){a.f=!1;a.h&&a.h()})}
function ci(a){a.i||(di(a),window.navigator.onLine&&a.g&&a.g())}
function di(a){a.i=kf(function(){window.navigator.onLine?(!1===a.f&&R(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&R(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());di(a)},Vh)}
;var ei=Ke("networkless_throttle_timeout")||100,fi=Ke("networkless_retry_attempts")||1,gi=0;function hi(a,b){b=void 0===b?{}:b;ii().then(function(c){var d=Zh().f;if(!c||S("networkless_bypass_write")||d&&S("vss_networkless_bypass_write"))Bg(a,b);else{var e={url:a,options:b,timestamp:U(),status:"NEW",sendCount:0};Ph(e).then(function(f){e.id=f;f=Zh();f.f&&!S("networkless_always_offline")?ji(e):$h(f)})["catch"](function(f){ji(e);
R(f)})}})}
function ai(){var a=this;gi||(gi=mf(function(){return K(a,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Rh(),2);if(3!=e.f)return d=e.g,d?w(e,ji(d),3):(bi(),e["return"]());gi=0;ai();e.f=0})})},ei))}
function bi(){of(gi);gi=0}
function ji(a){return K(this,function c(){var d;return x(c,function(e){switch(e.f){case 1:if(!a.id){e.J(2);break}return w(e,Sh(a.id),3);case 3:(d=e.g)?a=d:Fe(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=U()-f)){e.J(4);break}Fe(Error("Networkless Logging: Stored logs request expired age limit"));if(!a.id){e.J(5);break}return w(e,Uh(a.id),5);case 5:return e["return"]();case 4:f=a=ki(a);var g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||
void 0===g?void 0:g.C)||void 0===h?0:h.requestTimeMs)f.options.C.requestTimeMs=Math.round(U());(a=f)&&Bg(a.url,a.options);e.f=0}})})}
function ki(a){var b=this,c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){return K(b,function h(){return x(h,function(k){if(1==k.f)return a&&a.id?a.sendCount<fi?w(k,Th(a.id),6):w(k,Uh(a.id),2):k.J(2);2!=k.f&&$h(Zh());c(e,f);k.f=0})})};
...
return a}
function ii(){return K(this,function b(){return x(b,function(c){return S("networkless_logging")?(2===Ke("networkless_ytidb_version")&&Eh().then(function(d){return d}),c["return"](Dh())):c["return"](!1)})})}
...
v(li,Error);function mi(a){var b=this;this.f=null;a?this.f=a:Ig()&&(this.f=$f());kf(function(){Rg(b)},5E3)}
mi.prototype.isReady=function(){!this.f&&Ig()&&(this.f=$f());return!!this.f};
function cg(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&Fe(new li("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new li("innertube xhrclient not ready",b,c,d);R(e);e.sampleWeight=0;throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",C:c,xa:"JSON",U:function(){d.U()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.Pa)&&(g=e);var h=a.f.Ra||!1,k=Jg(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.Qa&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=lg(""+g+e,l||{},!0);ii().then(function(p){if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(S("networkless_gel")&&!p||!S("networkless_gel"))var q=Pg(b,
c,k,h);if(q){var t=f.onSuccess,z=f.va;f.onSuccess=function(E,W){Qg(q);t(E,W)};
c.va=function(E,W){Qg(q);z(E,W)}}}try{S("use_fetch_for_op_xhr")?yg(m,f):S("networkless_gel")&&d.retry?(f.method="POST",hi(m,f)):(f.method="POST",f.C||(f.C={}),Bg(m,f))}catch(E){if("InvalidAccessError"==E.name)q&&(Qg(q),q=0),Fe(Error("An extension is blocking network request."));
else throw E;}q&&kf(function(){Rg(a)},5E3)})}
;function ni(a,b,c){c=void 0===c?{}:c;var d=mi;Q("ytLoggingEventsDefaultDisabled",!1)&&mi==mi&&(d=null);eg(a,b,d,c)}
;var oi=[{ta:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]}]}}];function pi(){this.f=[];this.g=[]}
var qi;var ri=new O;var si=new Set,ti=0,ui=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function vi(a){wi(a,"WARNING")}
...
(window&&window.yterr||g)&&!(5<=ti)&&0!==a.sampleWeight)){var h=uc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.f||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var q=c,t=0;t<m.length&&!(m[t]&&(k+=xi(t,m[t],p,q),500<k));t++);else if("object"===typeof m)for(q in q=void 0,t=c,m){if(m[q]&&
(k+=xi(q,m[q],p,t),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,q=String(JSON.stringify(m[l])).substr(0,500),c[k]=q,p+=k.length+q.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c.vendor=
navigator.vendor);c={message:g,name:d,lineNumber:e,fileName:f,stack:h,params:c};a=Number(a.columnNumber);isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);a=u(oi);for(g=a.next();!g.done;g=a.next())if(g=g.value,g.na[c.name])for(e=u(g.na[c.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=c.message.match(f.regexp)){c.params["error.original"]=d[0];e=f.groups;f={};for(h=0;h<e.length;h++)f[e[h]]=d[h+1],c.params["error."+e[h]]=d[h+1];c.message=g.ta(f);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);
if(!(si.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){ri.P("handleError",c);if(S("kevlar_gel_error_routing")){a=b;a:{g=u(ui);for(d=g.next();!d.done;d=g.next())if(Wg(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);d=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==d.length&&(1!==d.length||isNaN(Number(d[0]))?2!==d.length||isNaN(Number(d[0]))||isNaN(Number(d[1]))||(g.lineNumber=Number(d[0]),
g.columnNumber=Number(d[1])):g.lineNumber=Number(d[0]));d=c.message;e=c.name;qi||(qi=new pi);f=qi;a:{h=u(f.g);for(l=h.next();!l.done;l=h.next())if(l=l.value,c.message&&c.message.match(l.f)){f=l.weight;break a}f=u(f.f);for(h=f.next();!h.done;h=f.next())if(h=h.value,h.Da(c)){f=h.weight;break a}f=1}d={level:"ERROR_LEVEL_UNKNOWN",message:d,errorClassName:e,sampleWeight:f};"ERROR"===a?d.level="ERROR_LEVEL_ERROR":"WARNING"===a&&(d.level="ERROR_LEVEL_WARNNING");a={isObfuscated:!0,browserStackInfo:g};g={pageUrl:window.location.href,
kvPairs:[]};if(e=c.params)for(f=u(Object.keys(e)),h=f.next();!h.done;h=f.next())h=h.value,g.kvPairs.push({key:"client."+h,value:String(e[h])});e=Q("SERVER_NAME",void 0);f=Q("SERVER_VERSION",void 0);e&&f&&(g.kvPairs.push({key:"server.name",value:e}),g.kvPairs.push({key:"server.version",value:f}));ni("clientError",{errorMetadata:g,stackTrace:a,logMessage:d});Wf()}}a=c.params||{};b={ib:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},C:{url:Q("PAGE_NAME",
...
b);si.add(c.message);ti++}}}
function xi(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function yi(){this.g=!1;this.f=null}
yi.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,bf(b,function(){g.g=!1;window.botguard?zi(g,c,d,f):(gf(b),vi(new li("Unable to load Botguard","from "+b)))},e)):a&&(S("botguard_eval_with_script_tag")?(e=Hc(document,"SCRIPT"),e.textContent=a,e.nonce=Ea(),document.head.appendChild(e),document.head.removeChild(e)):eval(a),window.botguard?zi(this,c,d,f):vi(Error("Unable to load Botguard from JS")))};
function zi(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:Ia)}catch(e){vi(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){vi(e)}c&&c(b)}}
yi.prototype.dispose=function(){this.f=null};var Ai=new yi;function Bi(){return!!Ai.f}
...
return a.join("")}
;var Fi=y.ytLoggingDocDocumentNonce_||Ei();A("ytLoggingDocDocumentNonce_",Fi,void 0);var Gi=1;function Hi(a){this.f=a}
...
function Ki(a){return Q(Ji(void 0===a?0:a),void 0)}
A("yt_logging_screen.getRootVeType",Ki,void 0);function Li(){var a=Ki(0),b;a?b=new Hi({veType:a,youtubeData:void 0}):b=null;return b}
function Mi(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function Ni(a){a=void 0===a?0:a;var b=Q(Ii(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(S("kevlar_client_side_screens")||S("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
A("yt_logging_screen.getCurrentCsn",Ni,void 0);function Oi(a,b,c){var d=Mi();(c=Ni(c))&&delete d[c];b&&(d[a]=b)}
function Pi(a){return Mi()[a]}
A("yt_logging_screen.getCttAuthInfo",Pi,void 0);function Qi(a,b,c,d){c=void 0===c?0:c;if(a!==Q(Ii(c))||b!==Q(Ji(c)))if(Oi(a,d,c),P(Ii(c),a),P(Ji(c),b),0==c||S("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&eg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Fi,clientScreenNonce:a},mi)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
A("yt_logging_screen.setCurrentScreen",Qi,void 0);function Ri(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Yb(window.location.href);g&&f.push(g);g=Yb(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Wb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Ni()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Ub(d).toString(36),e=e?$b(e):"",Ie(b,e,k||5))}else k=b,e="ST-"+Ub(d).toString(36),k=k?$b(k):"",Ie(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=ac(a,l)+m;a=a instanceof I?a:Jb(a);c.href=Fb(a)}return!0}
;function Si(a,b){this.version=a;this.args=b}
;function Ti(a,b){this.topic=a;this.f=b}
Ti.prototype.toString=function(){return this.topic};var Ui=B("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.T;O.prototype.publish=O.prototype.P;O.prototype.clear=O.prototype.clear;A("ytPubsub2Pubsub2Instance",Ui,void 0);var Vi=B("ytPubsub2Pubsub2SubscribedKeys")||{};A("ytPubsub2Pubsub2SubscribedKeys",Vi,void 0);var Wi=B("ytPubsub2Pubsub2TopicToKeys")||{};A("ytPubsub2Pubsub2TopicToKeys",Wi,void 0);var Xi=B("ytPubsub2Pubsub2IsAsync")||{};A("ytPubsub2Pubsub2IsAsync",Xi,void 0);
A("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Yi(a,b){var c=Zi();c&&c.publish.call(c,a.toString(),a,b)}
function $i(a){var b=aj,c=Zi();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=B("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Vi[d])try{if(f&&b instanceof Ti&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.K){var l=new h;h.K=l.version}var m=h.K}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){R(p)}},Xi[b.toString()]?B("yt.scheduler.instance")?mf(g):T(g,0):g())});
Vi[d]=!0;Wi[b.toString()]||(Wi[b.toString()]=[]);Wi[b.toString()].push(d);return d}
function bj(){var a=cj,b=$i(function(c){a.apply(void 0,arguments);dj(b)});
return b}
function dj(a){var b=Zi();b&&("number"===typeof a&&(a=[a]),H(a,function(c){b.unsubscribeByKey(c);delete Vi[c]}))}
function Zi(){return B("ytPubsub2Pubsub2Instance")}
;function ej(a){Si.call(this,1,arguments);this.csn=a}
v(ej,Si);var aj=new Ti("screen-created",ej),fj=[],gj=0;function hj(a,b,c){var d=S("use_default_events_client")?void 0:mi;b={csn:a,parentVe:b.getAsJson(),childVes:$a(c,function(f){return f.getAsJson()})};
c=u(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&vi(Error("Child VE logged with no data"));c={ga:Pi(a),V:a};"UNDEFINED_CSN"==a?ij("visualElementAttached",b,c):d?eg("visualElementAttached",b,d,c):ni("visualElementAttached",b,c)}
function ij(a,b,c){fj.push({payloadName:a,payload:b,options:c});gj||(gj=bj())}
function cj(a){if(fj){for(var b=u(fj),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,eg(c.payloadName,c.payload,null,c.options));fj.length=0}gj=0}
;function jj(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
jj.prototype.clone=function(){var a=new jj,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ka(c)?a[b]=mb(c):a[b]=c}return a};function kj(){M.call(this);this.f=[]}
v(kj,M);kj.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.Da)}M.prototype.o.call(this)};var lj=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function mj(a){a=a||"";if(window.spf){var b=a.match(lj);spf.style.load(a,b?b[1]:"",void 0)}else nj(a)}
function nj(a){var b=oj(a),c=document.getElementById(b),d=c&&Ne(c,"loaded");d||c&&!d||(c=pj(a,b,function(){Ne(c,"loaded")||(Le(c),Xe(b),T(Sa(Ye,b),0))}))}
function pj(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Vc(a);d.rel="stylesheet";d.href=ub(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function oj(a){var b=Hc(document,"A");Rb(b,new I(a,Eb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ub(a)}
;function qj(a,b,c,d){M.call(this);var e=this;this.m=this.aa=a;this.G=b;this.u=!1;this.api={};this.Y=this.F=null;this.H=new O;Pc(this,Sa(Qc,this.H));this.j={};this.N=this.Z=this.i=this.fa=this.f=null;this.M=!1;this.l=this.D=null;this.ba={};this.Aa=["onReady"];this.ea=null;this.oa=NaN;this.W={};this.h=d;rj(this);this.ca("WATCH_LATER_VIDEO_ADDED",this.Ta.bind(this));this.ca("WATCH_LATER_VIDEO_REMOVED",this.Ua.bind(this));this.ca("onAdAnnounce",this.Ca.bind(this));this.Ba=new kj(this);Pc(this,Sa(Qc,this.Ba));
this.X=0;c?this.X=T(function(){e.loadNewVideoConfig(c)},0):d&&(sj(this),tj(this))}
v(qj,M);n=qj.prototype;n.getId=function(){return this.G};
n.loadNewVideoConfig=function(a){if(!this.g){this.X&&(Pe(this.X),this.X=0);a instanceof jj||(a=new jj(a));this.fa=a;this.f=a.clone();sj(this);this.Z||(this.Z=uj(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Xc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Xc(Number(a)||a);tj(this);this.u&&vj(this)}};
function sj(a){var b;a.h?b=a.h.rootElementId:b=a.f.attrs.id;a.i=b||a.i;"video-player"==a.i&&(a.i=a.G,a.h?a.h.rootElementId=a.G:a.f.attrs.id=a.G);a.m.id==a.i&&(a.i+="-player",a.h?a.h.rootElementId=a.i:a.f.attrs.id=a.i)}
n.Ha=function(){return this.fa};
function vj(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function wj(a){var b=!0,c=xj(a);c&&a.f&&(a=yj(a),b=Ne(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function tj(a){if(!a.g&&!a.M){var b=wj(a);if(b&&"html5"==(xj(a)?"html5":null))a.N="html5",a.u||zj(a);else if(Aj(a),a.N="html5",b&&a.l)a.aa.appendChild(a.l),zj(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.D=function(){c=!0;var d=Bj(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.aa,e,a.h);zj(a)};
a.M=!0;b?a.D():(bf(yj(a),a.D),(b=a.h?a.h.cssUrl:a.f.assets.css)&&mj(b),Cj(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
function xj(a){var b=Dc(a.i);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.i));return b}
function zj(a){if(!a.g){var b=xj(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,!Bj(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Dj(a)):a.oa=T(function(){zj(a)},50)}}
function Dj(a){rj(a);a.u=!0;var b=xj(a);b.addEventListener&&(a.F=Ej(a,b,"addEventListener"));b.removeEventListener&&(a.Y=Ej(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Ej(a,b,e))}for(var f in a.j)a.F(f,a.j[f]);vj(a);a.Z&&a.Z(a.api);a.H.P("onReady",a.api)}
function Ej(a,b,c){var d=b[c];return function(){try{return a.ea=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ea=e,Fe(e))}}}
function rj(a){a.u=!1;if(a.Y)for(var b in a.j)a.Y(b,a.j[b]);for(var c in a.W)Pe(parseInt(c,10));a.W={};a.F=null;a.Y=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ca.bind(a);a.api.removeEventListener=a.Ya.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ia.bind(a);a.api.getPlayerType=a.Ja.bind(a);a.api.getCurrentVideoConfig=a.Ha.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Sa.bind(a)}
n.Sa=function(){return this.u};
n.ca=function(a,b){var c=this,d=uj(this,b);if(d){if(!(0<=Ya(this.Aa,a)||this.j[a])){var e=Fj(this,a);this.F&&this.F(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&T(function(){d(c.api)},0)}};
n.Ya=function(a,b){if(!this.g){var c=uj(this,b);c&&ie(this.H,a,c)}};
function uj(a,b){var c=b;if("string"==typeof b){if(a.ba[b])return a.ba[b];c=function(){var d=B(b);d&&d.apply(y,arguments)};
a.ba[b]=c}return c?c:null}
function Fj(a,b){var c="ytPlayer"+b+a.G;a.j[b]=c;y[c]=function(d){var e=T(function(){if(!a.g){a.H.P(b,d);var f=a.W,g=String(e);g in f&&delete f[g]}},0);
kb(a.W,String(e))};
return c}
...
n.Ja=function(){return this.N||(xj(this)?"html5":null)};
n.Ia=function(){return this.ea};
function Aj(a){a.cancel();rj(a);a.N=null;a.f&&(a.f.loaded=!1);var b=xj(a);b&&(wj(a)||!Cj(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.aa;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.D){var a=yj(this);hf(a,this.D)}Pe(this.oa);this.M=!1};
n.o=function(){Aj(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){R(b)}this.ba=null;for(var a in this.j)y[this.j[a]]=null;this.fa=this.f=this.api=null;delete this.aa;delete this.m;M.prototype.o.call(this)};
function Cj(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function yj(a){return a.h?a.h.jsUrl:a.f.assets.js}
function Bj(a,b){if(a.h)var c=a.h.serializedExperimentFlags;else a.f&&a.f.args&&(c=a.f.args.fflags);return"true"==ig(c||"")[b]}
;var Gj={},Hj="player_uid_"+(1E9*Math.random()>>>0);
function Ij(a,b,c){var d="player";c=void 0===c?!0:c;var e;"string"===typeof d?e=Dc(d):e=d;d=e;e=Hj+"_"+Na(d);var f=Gj[e];if(f&&c)return(b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true"))?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new qj(d,e,a,b);Gj[e]=f;Xe("player-added",f.api);Pc(f,Sa(Jj,f));return f.api}
function Jj(a){delete Gj[a.getId()]}
;function Kj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Lj(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});a:{if((b=a.mediaContentUrl)&&(b=/\/([ve]|embed)\/([^#?]+)/.exec(b))&&b[2]){b=b[2];break a}b=null}a.videoId=b;return Mj(a)}
function Mj(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function Nj(a,b,c,d){if(Ma(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Oj(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Pc(this,Sa(Qc,this.f))}
F(Oj,M);Oj.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
Oj.prototype.j=function(a,b){this.g||this.f.P.apply(this.f,arguments)};function Pj(a,b,c){Oj.call(this);this.h=a;this.i=b;this.l=c}
v(Pj,Oj);function Qj(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Kd(a),d.i))}}
Pj.prototype.o=function(){this.i=this.h=null;Oj.prototype.o.call(this)};function Rj(a){M.call(this);this.f=a;this.f.subscribe("command",this.ya,this);this.h={};this.j=!1}
v(Rj,M);n=Rj.prototype;n.start=function(){this.j||this.g||(this.j=!0,Qj(this.f,"RECEIVING"))};
n.ya=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=C(this.ab,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Sj(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Tj(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Uj(a,c))&&this.j&&!this.g&&Qj(this.f,a,c))}}};
n.ab=function(a,b){this.j&&!this.g&&Qj(this.f,a,this.ia(a,b))};
n.ia=function(a,b){if(null!=b)return{value:b}};
function Sj(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||ie(a.f,"command",this.ya,this);this.f=null;for(var b in this.h)Sj(this,b);M.prototype.o.call(this)};function Vj(a,b){Rj.call(this,b);this.i=a;this.start()}
v(Vj,Rj);Vj.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
Vj.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function Tj(a,b){switch(a){case "loadVideoById":return b=Mj(b),[b];case "cueVideoById":return b=Mj(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Nj(b),[b];case "cuePlaylist":return b=Nj(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Vj.prototype.ia=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Rj.prototype.ia.call(this,a,b)};
Vj.prototype.o=function(){Rj.prototype.o.call(this);delete this.i};function Wj(a,b,c){M.call(this);var d=this;c=c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.D=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.D&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(Wj,M);Wj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Fe(e)}}};
Wj.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function Xj(){var a=this.g=new Wj(!!Q("WIDGET_ID_ENFORCE")),b=C(this.Xa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=Xj.prototype;n.Xa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,Yj(this,a)),this.j[a]=!0)):this.ua(a,b,c)};
n.ua=function(){};
function Yj(a,b){return C(function(c){this.sendMessage(b,c)},a)}
...
function Zj(a,b){a.sendMessage("infoDelivery",b)}
n.za=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
n.sendMessage=function(a,b){this.za({event:a,info:void 0==b?null:b})};
n.dispose=function(){this.g=null};function ak(a){Xj.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.Va,this));this.addEventListener("onVideoProgress",C(this.fb,this));this.addEventListener("onVolumeChange",C(this.gb,this));this.addEventListener("onApiChange",C(this.Za,this));this.addEventListener("onPlaybackQualityChange",C(this.bb,this));this.addEventListener("onPlaybackRateChange",C(this.cb,this));this.addEventListener("onStateChange",C(this.eb,this));this.addEventListener("onWebglSettingsChanged",C(this.hb,
this))}
v(ak,Xj);n=ak.prototype;n.ua=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Kj(a)){var d=b;if(Ma(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Mj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Lj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Nj.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Kj(a)&&Zj(this,this.ja())}};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());Zj(this,a)};
n.bb=function(a){Zj(this,{playbackQuality:a})};
n.cb=function(a){Zj(this,{playbackRate:a})};
...
n.gb=function(){Zj(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.fb=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:D()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Zj(this,a)};
n.hb=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Zj(this,a)};
n.dispose=function(){Xj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function bk(a,b,c){M.call(this);this.f=a;this.i=c;this.j=Af(window,"message",C(this.l,this));this.h=new Pj(this,a,b);Pc(this,Sa(Qc,this.h))}
v(bk,M);bk.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
bk.prototype.o=function(){Bf(this.j);this.f=null;M.prototype.o.call(this)};function ck(){var a=mb(dk),b;return Yd(new N(function(c,d){a.onSuccess=function(e){sg(e)?c(e):d(new ek("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new ek("Unknown request error","net.unknown",e))};
a.U=function(e){d(new ek("Request timed out","net.timeout",e))};
b=Bg("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Zd&&b.abort();
return Wd(c)})}
function ek(a,b,c){G.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(ek,G);function fk(){this.g=0;this.f=null}
fk.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Qd(a)?a:gk(a)):2===this.g&&b?(a=b.call(c,this.f),Qd(a)?a:hk(a)):this};
fk.prototype.getValue=function(){return this.f};
fk.prototype.$goog_Thenable=!0;function hk(a){var b=new fk;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function gk(a){var b=new fk;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function ik(a){G.call(this,a.message||a.description||a.name);this.isMissing=a instanceof jk;this.isTimeout=a instanceof ek&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Zd}
v(ik,G);ik.prototype.name="BiscottiError";function jk(){G.call(this,"Biscotti ID is missing from server")}
v(jk,G);jk.prototype.name="BiscottiMissingError";var dk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},kk=null;
function gg(){if(S("disable_biscotti_fetch_on_html5_clients"))return Wd(Error("Fetching biscotti ID is disabled."));if(S("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!zc.get("CONSENT","").startsWith("YES+"))return Wd(Error("User has not consented - not fetching biscotti id."));if("1"===gb(Be(),"args","privembed"))return Wd(Error("Biscotti ID is not available in private embed mode"));kk||(kk=Yd(ck().then(lk),function(a){return mk(2,a)}));
return kk}
function lk(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new jk;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new jk;a=a.id;hg(a);kk=gk(a);nk(18E5,2);return a}
function mk(a,b){var c=new ik(b);hg("");kk=hk(c);0<a&&nk(12E4,a-1);throw c;}
function nk(a,b){T(function(){Yd(ck().then(lk,function(c){return mk(b,c)}),Ia)},a)}
function ok(){try{var a=B("yt.ads.biscotti.getId_");return a?a():gg()}catch(b){return Wd(b)}}
;function pk(a){if("1"!==gb(Be(),"args","privembed")){a&&fg();try{ok().then(function(){},function(){}),T(pk,18E5)}catch(b){R(b)}}}
;var Y=B("ytglobal.prefsUserPrefsPrefs_")||{};A("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function qk(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=zc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=qk.prototype;n.get=function(a,b){rk(a);sk(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){rk(a);sk(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){rk(a);sk(a);delete Y[a]};
...
function sk(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function rk(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function tk(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ja(qk);function uk(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!vk(a)||c.some(function(e){return!vk(e)}))throw Error("Only objects may be merged.");
c=u(c);for(d=c.next();!d.done;d=c.next())wk(a,d.value);return a}
function wk(a,b){for(var c in b)if(vk(b[c])){if(c in a&&!vk(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});wk(a[c],b[c])}else if(xk(b[c])){if(c in a&&!xk(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);yk(a[c],b[c])}else a[c]=b[c];return a}
function yk(a,b){for(var c=u(b),d=c.next();!d.done;d=c.next())d=d.value,vk(d)?a.push(wk({},d)):xk(d)?a.push(yk([],d)):a.push(d);return a}
...
c))&&c<l;){var m=a.charCodeAt(c-1);if(38==m||63==m){var p=a.charCodeAt(c+2);if(!p||61==p||38==p||35==p){var q=c;break d}}c+=3}q=-1}if(0>q)var t=null;else{var z=a.indexOf("&",q);if(0>z||z>l)z=l;q+=3;t=decodeURIComponent(a.substr(q,z-q).replace(/\+/g," "))}k="1"!==t}f=!k;break b}}catch(E){}f=!1}f?Ck(a)?(b&&b(),f=!0):f=!1:f=!1;f||Dk(a,b)}}
function Ck(a,b){try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,void 0===b?"":b))return!0}catch(c){}return!1}
function Dk(a,b){var c=new Image,d=""+Ak++;zk[d]=c;c.onload=c.onerror=function(){b&&zk[d]&&b();delete zk[d]};
c.src=a}
;function Ek(a,b){Si.call(this,1,arguments)}
v(Ek,Si);function Fk(a,b){Si.call(this,1,arguments)}
v(Fk,Si);var Gk=new Ti("aft-recorded",Ek),Hk=new Ti("timing-sent",Fk);var Ik=window;function Jk(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var Kk=Ik.performance||Ik.mozPerformance||Ik.msPerformance||Ik.webkitPerformance||new Jk;var Lk=!1;C(Kk.clearResourceTimings||Kk.webkitClearResourceTimings||Kk.mozClearResourceTimings||Kk.msClearResourceTimings||Kk.oClearResourceTimings||Ia,Kk);function Mk(a){var b=Nk(a);if(b.aft)return b.aft;a=Q((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Ok(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ta("ytcsi."+(a||"")+"data_",b));return b}
function Pk(a){a=Ok(a);a.info||(a.info={});return a.info}
function Nk(a){a=Ok(a);a.tick||(a.tick={});return a.tick}
function Qk(a){var b=Ok(a).nonce;b||(b=Ei(),Ok(a).nonce=b);return b}
function Rk(a){var b=Nk(a||""),c=Mk(a);c&&!Lk&&(Yi(Gk,new Ek(Math.round(c-b._start),a)),Lk=!0)}
;function Sk(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a,void 0),A("ytcsi.reference",{},void 0));return a}
function Tk(a){a=a||"";var b=B("ytcsi.reference");b||(Sk(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=Sk(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var Uk=y.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",Uk,void 0);function Vk(){this.f=0}
function Wk(){Vk.f||(Vk.f=new Vk);return Vk.f}
Vk.prototype.tick=function(a,b,c){Xk(this,"tick_"+a+"_"+b)||ni("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
Vk.prototype.info=function(a,b){var c=Object.keys(a).join("");Xk(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,ni("latencyActionInfo",c))};
Vk.prototype.span=function(a,b){var c=Object.keys(a).join("");Xk(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,ni("latencyActionSpan",a))};
function Xk(a,b){Uk[b]=Uk[b]||{count:0};var c=Uk[b];c.count++;c.time=U();a.f||(a.f=kf(function(){var d=U(),e;for(e in Uk)Uk[e]&&6E4<d-Uk[e].time&&delete Uk[e];a&&(a.f=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new li("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||vi(c)),!0):!1}
...
$k={},al=($k.ccs="CANARY_STATE_",$k.mver="MEASUREMENT_VERSION_",$k.pis="PLAYER_INITIALIZED_STATE_",$k.yt_pt="LATENCY_PLAYER_",$k.pa="LATENCY_ACTION_",$k.yt_vst="VIDEO_STREAM_TYPE_",$k),bl="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function cl(a){return!!Q("FORCE_CSI_ON_GEL",!1)||S("csi_on_gel")||!!Ok(a).useGel}
function dl(a){a=Ok(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function el(a,b,c){if(null!==b)if(Pk(c)[a]=b,cl(c)){var d=b;b=dl(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in Yk){b=Yk[a];0<=Ya(Zk,b)&&(d=!!d);a in al&&"string"===typeof d&&(d=al[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=uk({},e)}else 0<=Ya(bl,a)||vi(new li("Unknown label logged with GEL CSI",
a)),f=void 0;f&&cl(c)&&(b=Tk(c||""),uk(b.info,f),b=dl(c),"gelInfos"in b||(b.gelInfos={}),uk(b.gelInfos,f),c=Qk(c),Wk().info(f,c))}else Tk(c||"").info[a]=b}
function fl(a,b,c){var d=Nk(c);if(S("use_first_tick")&&gl(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;Kk.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),Kk.mark(e))}e=b||U();d[a]=e;e=dl(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||U();if(cl(c)){Tk(c||"").tick[a]=b||U();e=Qk(c);if("_start"===a){var f=Wk();Xk(f,"baseline_"+e)||ni("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else Wk().tick(a,e,b);Rk(c);e=!0}else e=!1;if(!e){if(!B("yt.timing."+(c||"")+"pingSent_")&&
(f=Q((c||"")+"TIMING_ACTION",void 0),e=Nk(c),B("ytglobal.timing"+(c||"")+"ready_")&&f&&gl("_start")&&Mk(c)))if(Rk(c),c)hl(c);else{f=!0;var g=Q("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&hl(c)}Tk(c||"").tick[a]=b||U()}return d[a]}
function gl(a,b){var c=Nk(b);return a in c}
function hl(a){if(!cl(a)){var b=Nk(a),c=Pk(a),d=b._start,e=Q("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:Q((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Mk(a);var h=Nk(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&Pk(a).yt_pvis&&"youtube"===e&&(el("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=U();m={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),m[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;S("debug_csi_data")&&(c=B("yt.timing.csiData"),c||(c=[],Ta("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var q in f)f.hasOwnProperty(q)&&(c+="&"+q+"="+f[q]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var t=void 0===t?"":t;Ck(f,t)||Bk(f,void 0,void 0,void 0,t)}else Bk(f);A("yt.timing."+(a||"")+"pingSent_",!0,void 0);Yi(Hk,new Fk(m.aft+(Number(g)||0),a))}}
var il=window;il.ytcsi&&(il.ytcsi.info=el,il.ytcsi.tick=fl);var jl=null,kl=null,ll=null,ml={};function nl(a){var b=a.id;a=a.ve_type;var c=Gi++;a=new Hi({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});ml[b]=a;b=Ni();c=Li();b&&c&&hj(b,c,[a])}
function ol(){var a=jl.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
function pl(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Qi(b,a),a=Li()))for(var c in ml){var d=ml[c];d&&hj(b,a,[d])}}
function ql(a){ml[a.id]=new Hi({trackingParams:a.tracking_params})}
function rl(a){var b=Ni(),c=ml[a.id];if(b&&c){a=S("use_default_events_client")?void 0:mi;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={ga:Pi(b),V:b};"UNDEFINED_CSN"==b?ij("visualElementGestured",c,d):a?eg("visualElementGestured",c,a,d):ni("visualElementGestured",c,d)}}
function sl(a){a=a.ids;var b=Ni();if(b)for(var c=0;c<a.length;c++){var d=ml[a[c]];if(d){var e=b,f=S("use_default_events_client")?void 0:mi;d={csn:e,ve:d.getAsJson(),eventType:1};var g={ga:Pi(e),V:e};"UNDEFINED_CSN"==e?ij("visualElementShown",d,g):f?eg("visualElementShown",d,f,g):ni("visualElementShown",d,g)}}}
;A("yt.setConfig",P,void 0);A("yt.config.set",P,void 0);A("yt.setMsg",He,void 0);A("yt.msgs.set",He,void 0);A("yt.logging.errors.log",wi,void 0);
A("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);if(!a){var b=Q("PLAYER_VARS",void 0);b&&(a={args:b})}pk(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");a.args.forced_experiments||(b=window.location.href,-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=kg(1<b.length?b[1]:b[0])):b={},b.forced_experiments&&(a.args.forced_experiments=b.forced_experiments));a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=Q("POST_MESSAGE_ORIGIN");
window!=window.top&&c&&c!=document.URL&&(a.args.loaderUrl=c);jl=a=(c=Q("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c?Ij(a,c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,!1):Ij(a);a.addEventListener("onScreenChanged",pl);a.addEventListener("onLogClientVeCreated",nl);a.addEventListener("onLogServerVeCreated",ql);a.addEventListener("onLogVeClicked",rl);a.addEventListener("onLogVesShown",sl);a.addEventListener("onVideoDataChange",ol);c=Q("POST_MESSAGE_ID","player");
Q("ENABLE_JS_API")?ll=new ak(a):Q("ENABLE_POST_API")&&"string"===typeof c&&"string"===typeof b&&(kl=new bk(window.parent,c,b),ll=new Vj(a,kl.h));rf()},void 0);
var tl=Ee(function(){fl("ol");var a=qk.getInstance(),b=!!((tk("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Id(document.body,"exp-invert-logo"))if(c&&!Id(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Id(d,"inverted-hdpi")){var e=Gd(d);Hd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Id(document.body,"inverted-hdpi")&&Jd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=tk(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),ul=Ee(function(){var a=jl;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Ai.dispose();a=0;for(var b=pf.length;a<b;a++)of(pf[a]);pf.length=0;gf("//static.doubleclick.net/instream/ad_status.js");qf=!1;P("DCLKSTAT",0);Rc(ll,kl);if(a=jl)a.removeEventListener("onScreenChanged",pl),a.removeEventListener("onLogClientVeCreated",nl),a.removeEventListener("onLogServerVeCreated",ql),a.removeEventListener("onLogVeClicked",rl),a.removeEventListener("onLogVesShown",sl),a.removeEventListener("onVideoDataChange",ol),a.destroy();
ml={}});
window.addEventListener?(window.addEventListener("load",tl),window.addEventListener("unload",ul)):window.attachEvent&&(window.attachEvent("onload",tl),window.attachEvent("onunload",ul));Ta("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Bi);Ta("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Ci);Ta("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||sf);
Ta("yt.player.exports.navigate",B("yt.player.exports.navigate")||Ri);Ta("yt.util.activity.init",B("yt.util.activity.init")||Ff);Ta("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||If);Ta("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||Gf);}).call(this);
